...
function LoginSuccessMessage() {
  ...
  return (
    <div className="mb-6 px-4 py-3 rounded-xl bg-emerald-50/80 border border-emerald-200/50 text-emerald-700 text-[12.5px] text-center tracking-wide">
      {message}
    </div>
  )
}
  ...
  return (
    <>
      <style>{`
        ...
        .anim-testimonial { opacity: 0; animation: fadeUp 0.9s cubic-bezier(0.22,1,0.36,1) 0.55s forwards; }
        ...
        .photo-glow::after {
          ...
          background: conic-gradient(
            from 180deg,
            rgba(61,90,128,0.5), rgba(157,120,85,0.3),
            rgba(61,90,128,0.15), rgba(157,120,85,0.3),
            rgba(61,90,128,0.5)
          );
          z-index: -1; opacity: 0.6; filter: blur(1px);
        }
          ...
          <div className="relative z-[2] flex flex-col justify-between h-full">
            ...
            <div className="anim-hero max-w-[520px]">
              <p className="f-mono mb-7 flex items-center gap-3 text-[9.5px] uppercase tracking-[0.28em] text-[#5b7ea1]">
                ...
                Diabetes Emotional Support Study
              </p>
              <h1
              ...
              >
                Supporting you,{' '}
                <em className="italic font-light text-white/30">one day
                at a time.</em>
              </h1>
              <p className="max-w-[380px] text-sm font-light leading-[1.75] text-white/[0.32]">
                A secure platform providing AI-driven emotional support
                for adults living with Type 2 Diabetes — tracking distress,
                building coping skills, and connecting you with care.
              </p>
            </div>

            {/* ── Featured Researcher Testimonial ── */}
            <div className="anim-testimonial">
              <div className="max-w-[460px] rounded-2xl border border-white/[0.06] bg-white/[0.03] backdrop-blur-sm px-7 py-6">
                  ...
                  <div className="shrink-0">
                    <div className="photo-glow">
                      <img
                        ...
                        className="h-[60px] w-[60px] rounded-full object-cover object-top border-[2px] border-white/10"
                      />
                    </div>
                  </div>
                  {/* Quote & attribution */}
                  <div className="flex flex-col gap-3 min-w-0">
                    <svg className="h-[14px] w-[14px] text-[#5b7ea1] opacity-50 shrink-0" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M14.017 21v-7.391C14.017 10.035 16.545 7 20 5.926V8.27c-1.607.662-2.677 2.338-2.797 4.073h2.781V21h-5.967zM4.017 21v-7.391C4.017 10.035 6.545 7 10 5.926V8.27c-1.607.662-2.677 2.338-2.797 4.073h2.781V21H4.017z" />
                    </svg>
                    <p className="text-[13px] font-light leading-[1.7] text-white/[0.45] italic">
                      AIDES-T2D gives participants a safe, private space to
                      process the emotional weight of diabetes — every single day.
                    </p>
                    <div className="flex items-center gap-2 pt-1">
                      <span className="text-[12px] font-medium text-white/[0.65]">
                        Michelle Boakye
                      </span>
                      <span className="text-white/[0.15]">·</span>
                      <span className="f-mono text-[9px] uppercase tracking-[0.14em] text-white/[0.25]">
            ...
            <div className="anim-stats flex items-center">
              {[
                { value: '4', label: 'Study Weeks' },
                { value: '4', label: 'Distress Domains' },
          ...
          <div className="anim-form relative z-10 w-full max-w-[380px]">
            ...
            <div className="mb-10">
              ...
              <p className="text-[13px] font-light leading-[1.6] text-black/60">
                Sign in to continue your AIDES-T2D daily check-in with Stampley.
              </p>
            </div>
            ...
            <div className="mt-8 flex flex-col gap-5">
              ...
              <p className="text-center text-[12.5px] font-light text-black/70">
                ...
                <Link
                  href="/register"
                  className="font-medium text-[1rem] cursor-pointer text-[#0a0a0f] no-underline border-b border-black/20 transition-all duration-200 hover:border-[#3d5a80] hover:text-[#3d5a80]"
                >
              ...
              <p className="text-center text-[11.5px] font-light text-black/50">
                Study coordinator?{' '}
                <Link
                  href="/admin/login"
                  className="group font-medium text-black/70 no-underline transition-colors duration-150 hover:text-[#0a0a0f]"
                >
                  Admin sign in
                  <span className="ml-0.5 inline-block transition-all duration-200 group-hover:ml-1.5">
                    →
                  </span>
                </Link>
              </p>
