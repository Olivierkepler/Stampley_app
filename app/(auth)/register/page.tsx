            ...
            <div className="anim-hero max-w-[520px]">
              ...
              >
                ...
                <em className="italic font-light text-white/30">
                  with
                  <span className="text-white/30 text-[2.5rem]"> AIDES-T2D.</span>
                </em>
              </h1>
              <p className="max-w-[380px] text-sm font-light leading-[1.75] text-white/[0.32]">
                Your Study ID connects you to the AIDES-T2D program. Once registered,
                you&apos;ll check in daily with Stampley and track your emotional
                well-being over 4 weeks.
              </p>
            </div>
                ...
                {[
                  {
                    ...
                    desc: 'The unique key provided by your AIDES-T2D research coordinator.',
                  },
                  {
                    num: '02',
                    title: 'Create your account',
                    desc: 'Set a secure email and password to access your participant portal.',
                  },
                  {
                    num: '03',
                    title: 'Start your daily check-ins',
                    desc: 'Log distress, mood, and coping with Stampley — every day for 4 weeks.',
                  },
                ].map((step, i) => (
          ...
          <div className="anim-form relative z-10 w-full max-w-[380px]">
            ...
            <div className="mb-10">
              ...
              <p className="text-[13px] font-light leading-[1.6] text-black/60">
                Enter your Study ID to create your AIDES-T2D participant account
                and begin checking in with Stampley.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="flex flex-col gap-2">
                <label htmlFor="studyId" className="f-mono text-[9.5px] uppercase tracking-[0.16em] text-black/70 select-none">
                  Study ID (Invitation Key)
                </label>
                ...
                <p className="text-[10.5px] text-black/35 font-light pl-1">
                  Provided by your AIDES-T2D research coordinator
                </p>
              </div>
                ...
                <span className="relative z-10 flex items-center justify-center gap-2">
                  {loading ? (
                    <>
                      ...
                      <span className="text-[11px] tracking-[0.12em]">Verifying Study ID…</span>
                    </>
                  ) : (
                    <>
                      Create My Account
